...
brokerRouter.get('/get-all-brokers', (_req: Request, res: Response) => {
...
brokerRouter.get('/getByIds/id', (req: Request, res: Response) => {
...
brokerRouter.get('/?filter=name', (req: Request, res: Response) => {
...
brokerRouter.get('/:id', (req: Request, res: Response) => {
  console.log(`Sending response for fetching broker with id ${req.params.id}`);
  res.send({
    ...broker,
    id: req.params.id,
